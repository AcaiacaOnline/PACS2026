      ...
      <div className="bg-card p-8 rounded-xl shadow-2xl w-full max-w-md backdrop-blur-sm bg-opacity-95 border border-border">
        ...
        <form onSubmit={handleSubmit} className="space-y-4" data-testid="login-form">
          ...
          <button
            ...
            className="w-full bg-card border-2 border-border text-foreground font-semibold py-3 rounded-lg hover:bg-accent hover:text-accent-foreground transition-colors flex items-center justify-center gap-2"
          >
